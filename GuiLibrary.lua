...
local Utility = {}
local Objects = {}
function Ashura:DraggingEnabled(frame, parent)
...
function Ashura:CreateWindow(name, themeList)
	...
	Ashura:DraggingEnabled(MainHeader, Main)
	...
	function Ashura:ChangeColor(prope,color)
		...
		local counter = 0
		function Ashura:Rainbow()
			while task.wait(.06) do
				themeList.SchemeColor = Color3.fromHSV(zigzag(counter),1,1)
				themeList.Background = Color3.fromHSV(zigzag(counter),1,1)
				themeList.Header = Color3.fromHSV(zigzag(counter),1,1)
				themeList.TextColor = Color3.fromHSV(zigzag(counter),1,1)
				themeList.ElementColor = Color3.fromHSV(zigzag(counter),1,1)
				counter = counter + .01
			end
		end
	end
